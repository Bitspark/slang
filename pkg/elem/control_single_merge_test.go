...
func Test_CtrlSingleMerge__IsRegistered(t *testing.T) {
	a := assertions.New(t)
...
func Test_CtrlSingleMerge__InPorts(t *testing.T) {
	a := assertions.New(t)
...
func Test_CtrlSingleMerge__OutPorts(t *testing.T) {
	a := assertions.New(t)
...
func Test_CtrlSingleMerge__Works(t *testing.T) {
	a := assertions.New(t)
...
func Test_CtrlSingleMerge__ComplexItems(t *testing.T) {
	a := assertions.New(t)
