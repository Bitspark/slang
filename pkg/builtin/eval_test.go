...
func TestBuiltin_Eval__Add(t *testing.T) {
	...
	a.NoError(err)
	a.NotNil(fo)
	fo.DefaultService().Out().Bufferize()

	go fo.Start()

	fo.DefaultService().In().Push(map[string]interface{}{"a": 1.0, "b": 2.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": -5.0, "b": 2.5})
	fo.DefaultService().In().Push(map[string]interface{}{"a": 0.0, "b": 333.0})

	a.PortPushes([]interface{}{3.0, -2.5, 333.0}, fo.DefaultService().Out())
}
...
func TestBuiltin_Eval__Floor(t *testing.T) {
	...
	fo.DefaultService().In().Push(map[string]interface{}{"a": 1.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": 1.1})
	fo.DefaultService().In().Push(map[string]interface{}{"a": 2.9})

	a.PortPushes([]interface{}{1.0, 1.0, 2.0}, fo.DefaultService().Out())
}
...
func TestBuiltin_Eval__Ceil(t *testing.T) {
	...
	a.PortPushes([]interface{}{1.0, 2.0, 3.0}, fo.DefaultService().Out())
}
...
func TestBuiltin_Eval__IsNull(t *testing.T) {
	...
	fo.DefaultService().In().Push(map[string]interface{}{"a": 1.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": nil})
	fo.DefaultService().In().Push(map[string]interface{}{"a": "testtest"})

	a.PortPushes([]interface{}{false, true, false}, fo.DefaultService().Out())
}
...
func TestBuiltin_Eval__BoolArith(t *testing.T) {
	...
	fo.DefaultService().In().Push(map[string]interface{}{"a": true, "b": 1.0, "c": 2.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": false, "b": 8.0, "c": 8.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": false, "b": 3.0, "c": 2.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": true, "b": 1.0, "c": 0.0})
	fo.DefaultService().In().Push(map[string]interface{}{"a": true, "b": 8.0, "c": 8.0})

	a.PortPushes([]interface{}{true, false, false, true, false}, fo.DefaultService().Out())
}
...
func TestBuiltin_Eval_VectorArith(t *testing.T) {
	...
	fo.DefaultService().In().Push(map[string]interface{}{
	...
	a.PortPushes([]interface{}{26., 0., 2.}, fo.DefaultService().Out())
}
