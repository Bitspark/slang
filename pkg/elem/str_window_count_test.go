...
func Test_StreamWindowCount__IsRegistered(t *testing.T) {
	a := assertions.New(t)

	ocWnd := getBuiltinCfg("slang.stream.WindowCount")
	a.NotNil(ocWnd)
}
...
func makeTestMonoWindow(t *testing.T, size, slide, start, end int) *core.Operator {
	...
	o, err := buildOperator(
		core.InstanceDef{
			Operator: "slang.stream.WindowCount",
...
func Test_StreamWindowCount__3_3_3_3(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_3_1_3(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_3_1_2(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_3_2_1(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_2_2_2(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_2_2_3(t *testing.T) {
	a := assertions.New(t)
...
func Test_StreamWindowCount__3_1_2_2(t *testing.T) {
	a := assertions.New(t)
