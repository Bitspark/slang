...
func TestPortDef_Validate__InvalidTypeInDefinition(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"gfdhgfd"}`)
...
func TestPortDef_Validate__Stream__StreamNotPresent(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream"}`)
...
func TestPortDef_Validate__Stream__NilStream(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":null}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Stream__EmptyStream(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":{}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Stream__InvalidTypeInDefinition(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":{"type":"hgfdh"}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__MapNotPresent(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map"}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__NilMap(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":null}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__EmptyMap(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__NullEntry(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":null}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__EmptyEntry(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":{}}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Map__InvalidTypeInDefinition(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"gfgfd"}}}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Generic__IdentifierMissing(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"generic"}`)
	a.Error(def.Validate())
	a.False(def.Valid(), "should not be valid")
}
...
func TestPortDef_Validate__Generic__Correct(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"generic", "generic":"id1"}`)
...
func TestNewPort__InvalidDefinition(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"bcvbvcbvc"}`)
...
func TestNewPort__Number__NoDirectionGiven(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"number"}`)
	p, err := core.NewPort(nil, nil, def, 0)
	a.Error(err)
	a.Nil(p)
}
...
func TestNewPort__Stream(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":{"type":"number"}}`)
	p, err := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.NoError(err)
...
func TestNewPort__Map(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"}}}`)
	p, err := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.NoError(err)
...
func TestNewPort__NestedStreams(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":{"type":"stream","stream":{"type":"string"}}}`)
	p, err := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.NoError(err)
	a.Equal(core.TYPE_STREAM, p.Type(), "wrong type")
...
func TestNewPort__NestedMap(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"},"b":{"type":"map","map":{"a":{"type":"number"}}}}}`)
	p, err := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.NoError(err)
	a.NotNil(p)
	a.Equal(core.TYPE_NUMBER, p.Map("a").Type(), "wrong type")
...
func TestPort_Type__Simple__Primitive(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"primitive"}`)
...
func TestPort_Type__Simple__Trigger(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"trigger"}`)
	p, _ := core.NewPort(nil, nil, def, core.DIRECTION_IN)
...
func TestPort_Type__Simple__String(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"string"}`)
	p, _ := core.NewPort(nil, nil, def, core.DIRECTION_IN)
...
func TestPort_Type__Simple__Boolean(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"boolean"}`)
	p, _ := core.NewPort(nil, nil, def, core.DIRECTION_IN)
...
func TestPort_Type__Map(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"boolean"}}}`)
	p, _ := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.Equal(core.TYPE_MAP, p.Type(), "wrong type")
...
func TestPort_Type__Stream(t *testing.T) {
	a := assertions.New(t)
	def := slapi.ParsePortDef(`{"type":"stream","stream":{"type":"string"}}`)
	p, _ := core.NewPort(nil, nil, def, core.DIRECTION_IN)
	a.Equal(core.TYPE_STREAM, p.Type(), "wrong type")
...
func TestPort_Connect__Map__KeysNotMatching(t *testing.T) {
	a := assertions.New(t)
	def1 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"}}}`)
	def2 := slapi.ParsePortDef(`{"type":"map","map":{"b":{"type":"number"}}}`)
...
func TestPort_Connect__Map__LeftIsSubsetOfRight(t *testing.T) {
	a := assertions.New(t)
	def1 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"}}}`)
	def2 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"},"b":{"type":"number"}}}`)
...
func TestPort_Connect__Map__RightIsSubsetOfRight(t *testing.T) {
	a := assertions.New(t)
	def1 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"},"b":{"type":"number"}}}`)
	def2 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"}}}`)
...
func TestPort_Connect__Map__IncompatibleTypes(t *testing.T) {
	a := assertions.New(t)
	def1 := slapi.ParsePortDef(`{"type":"map","map":{"a":{"type":"number"}}}`)
	def2 := slapi.ParsePortDef(`{"type":"number"}`)
