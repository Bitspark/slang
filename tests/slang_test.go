...
func TestParsePortReference__NilConnection(t *testing.T) {
	a := assertions.New(t)
	o1, _ := core.NewOperator("o1", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "number"}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2, _ := core.NewOperator("o2", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "number"}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2.SetParent(o1)
...
func TestParsePortReference__Map(t *testing.T) {
	a := assertions.New(t)
	o1, _ := core.NewOperator("o1", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "number"}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2, _ := core.NewOperator("o2", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "map", Map: map[string]*core.TypeDef{"a": {Type: "number"}}}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2.SetParent(o1)
...
func TestParsePortReference__NestedMap(t *testing.T) {
	a := assertions.New(t)
	o1, _ := core.NewOperator("o1", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "number"}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2, _ := core.NewOperator("o2", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "map", Map: map[string]*core.TypeDef{"a": {Type: "map", Map: map[string]*core.TypeDef{"b": {Type: "number"}}}}}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2.SetParent(o1)
...
func TestParsePortReference__Stream(t *testing.T) {
	a := assertions.New(t)
	o1, _ := core.NewOperator("o1", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "number"}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2, _ := core.NewOperator("o2", nil, nil, nil, nil, map[string]*core.ServiceDef{core.MAIN_SERVICE: {In: core.TypeDef{Type: "stream", Stream: &core.TypeDef{Type: "number"}}, Out: core.TypeDef{Type: "number"}}}, nil)
	o2.SetParent(o1)
	p, err := api.ParsePortReference("~(o2", o1)
	a.NoError(err)
...
func TestParsePortReference__Delegates_Map(t *testing.T) {
	a := assertions.New(t)
	o1, _ := core.NewOperator(
		"o1", nil, nil, nil, nil, map[string]*core.ServiceDef{
			core.MAIN_SERVICE: {
				In:  core.TypeDef{Type: "number"},
				Out: core.TypeDef{Type: "number"},
			},
