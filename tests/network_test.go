...
func TestNetwork_EmptyOperators(t *testing.T) {
	...
	defOut := api.ParsePortDef(`{"type":"number"}`)
	o1, _ := core.NewOperator("o1", nil, nil, map[string]*core.ServiceDef{"main": {In: defIn, Out: defOut}}, nil)
	o2, _ := core.NewOperator("o2", nil, nil, map[string]*core.ServiceDef{"main": {In: defIn, Out: defOut}}, nil)
	o2.SetParent(o1)
	o3, _ := core.NewOperator("o3", nil, nil, map[string]*core.ServiceDef{"main": {In: defIn, Out: defOut}}, nil)
	o3.SetParent(o2)
...
func TestNetwork_DoubleSum(t *testing.T) {
	...
	o1, _ := core.NewOperator("O1", nil, nil, map[string]*core.ServiceDef{"main": {In: defStrStr, Out: defStr}}, nil)
	o2, _ := core.NewOperator("O2", nil, nil, map[string]*core.ServiceDef{"main": {In: defStr, Out: def}}, nil)
	o2.SetParent(o1)
	o3, _ := core.NewOperator("O3", double, nil, map[string]*core.ServiceDef{"main": {In: def, Out: def}}, nil)
	o3.SetParent(o2)
...
func TestNetwork_NumgenSum(t *testing.T) {
	...
	o1, _ := core.NewOperator("O1", nil, nil, map[string]*core.ServiceDef{"main": {In: defStr, Out: defStrStr}}, nil)
	o2, _ := core.NewOperator("O2", numgen, nil, map[string]*core.ServiceDef{"main": {In: def, Out: defStr}}, nil)
	o2.SetParent(o1)
	o3, _ := core.NewOperator("O3", numgen, nil, map[string]*core.ServiceDef{"main": {In: def, Out: defStr}}, nil)
	o3.SetParent(o1)
	o4, _ := core.NewOperator("O4", nil, nil, map[string]*core.ServiceDef{"main": {In: defStrStrStr, Out: defStrStr}}, nil)
	o4.SetParent(o1)
...
func TestNetwork_Maps_Simple(t *testing.T) {
	...
	o, _ := core.NewOperator("", nil, nil, map[string]*core.ServiceDef{"main": {In: defIn, Out: defOut}}, nil)
	oMap1, _ := core.NewOperator("Map1", evalMap1, nil, map[string]*core.ServiceDef{"main": {In: defMap1In, Out: defMap1Out}}, nil)
	oMap1.SetParent(o)
...
func TestNetwork_Maps_Complex(t *testing.T) {
	...
	o, _ := core.NewOperator("Global", nil, nil, map[string]*core.ServiceDef{"main": {In: defStrMapStr, Out: defStrMap}}, nil)
	sum, _ := core.NewOperator("Sum", sumEval, nil, map[string]*core.ServiceDef{"main": {In: defSumIn, Out: defSumOut}}, nil)
	sum.SetParent(o)
	add, _ := core.NewOperator("Add", addEval, nil, map[string]*core.ServiceDef{"main": {In: defAddIn, Out: defAddOut}}, nil)
	add.SetParent(o)
	filter1, _ := core.NewOperator("Filter1", filterEval, nil, map[string]*core.ServiceDef{"main": {In: defFilterIn, Out: defFilterOut}}, nil)
	filter1.SetParent(o)
